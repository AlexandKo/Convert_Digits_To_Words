...
@Marker(value = 7)
public class DigitSeven implements DigitPrescription {
    ...
    public String digitPrescriptionFinder(Languages setLanguage) {
        ...
        return switch (setLanguage) {
            case LAT -> digitZeroProperties.get("seven_LV").toString();
            case ENG -> digitZeroProperties.get("seven_EN").toString();
        };
    }
}